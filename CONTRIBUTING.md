# Contributing to the WP-API JSON Feed plugin
...
* `pnpm lint-php`: Lints all PHP code (run after adding new code to the repository)
* `pnpm format-php`: Formats all PHP code (run after adding new code to the repository)
